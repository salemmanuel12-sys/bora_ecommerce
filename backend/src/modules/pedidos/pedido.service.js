...
const ENVIATODO_ORIGIN = {
  ...
  lng: 0,
  address_type_id: '1',
  full_name: 'Iram Cortes',
  email: 'calebalejandrocortes@gmail.com',
  telephone: '5561259840',
  street: 'Via Adolfo Lopez Mateos',
  ext_number: '1B',
  int_number: '102',
  zip_code: '54059',
  suburb: 'Francisco Villa',
  municipality: 'Tlalnepantla de Baz',
  town: 'Tlalnepantla de Baz',
  state: 'México',
  state_code: 'MC',
  country_code: 'MX',
  reference: 'Porton blanco con verde',
  default_addr: 'false',
};
